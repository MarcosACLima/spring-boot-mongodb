...
public class InstaciacaoBaseDados implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Postagem postagem1 = new Postagem(null, sdf.parse("16/03/2020"), "Partiu viagem", "Vou viajar para São Paulo. Abraços!", maria);
		Postagem postagem2 = new Postagem(null, sdf.parse("23/03/2020"), "Bom dia", "Acordei feliz hoje!", maria);
